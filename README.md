...
- [systemxlabs/notebook](https://github.com/systemxlabs/notebook) - 笔记和思考 (6 days ago)
...
- [Use default clippy lints and remove unused unstable features](https://github.com/KipData/KipDB/pull/49) on [KipData/KipDB](https://github.com/KipData/KipDB) (1 day ago)
- [Remove unnecessary mod](https://github.com/KipData/KipDB/pull/48) on [KipData/KipDB](https://github.com/KipData/KipDB) (2 days ago)
- [Cleanup text related](https://github.com/KipData/KipSQL/pull/84) on [KipData/KipSQL](https://github.com/KipData/KipSQL) (2 days ago)
- [Improve update error](https://github.com/apache/arrow-datafusion/pull/7777) on [apache/arrow-datafusion](https://github.com/apache/arrow-datafusion) (2 days ago)
- [refactor: replace once_cell with std](https://github.com/datafuselabs/databend/pull/13127) on [datafuselabs/databend](https://github.com/datafuselabs/databend) (3 days ago)

#### ⭐ Check out my recent stars

- [Dreamacro/clash](https://github.com/Dreamacro/clash) - A rule-based tunnel in Go. (3 days ago)
