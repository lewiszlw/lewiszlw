...
- [Minor: Improve documentation for AggregateUDFImpl::state_fields](https://github.com/apache/datafusion/pull/11740) on [apache/datafusion](https://github.com/apache/datafusion) (1 day ago)
- [Create `name` of aggregate expression from expressions](https://github.com/apache/datafusion/pull/11739) on [apache/datafusion](https://github.com/apache/datafusion) (1 day ago)
- [Evaluate ValuesExec&#39;s exprs during execution](https://github.com/apache/datafusion/pull/11737) on [apache/datafusion](https://github.com/apache/datafusion) (1 day ago)
- [Rename `input_type` --&gt; `input_types` on AggregateFunctionExpr / AccumulatorArgs / StateFieldsArgs](https://github.com/apache/datafusion/pull/11666) on [apache/datafusion](https://github.com/apache/datafusion) (6 days ago)
- [Concurrent collect](https://github.com/sundy-li/arrow_cli/pull/20) on [sundy-li/arrow_cli](https://github.com/sundy-li/arrow_cli) (6 days ago)
...
- [Replace to_lowercase with to_string in sql example](https://github.com/apache/datafusion/pull/11486) on [apache/datafusion](https://github.com/apache/datafusion) (2 weeks ago)
